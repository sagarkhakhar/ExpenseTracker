...
void main() {
  ...
  group('ExportToJson', () {
    ...
    test('should export expenses to JSON successfully', () async {
      // Arrange
      when(() => mockExportService.exportToJson(testExpenses))
      ...
      verify(() => mockExportService.exportToJson(testExpenses)).called(1);
